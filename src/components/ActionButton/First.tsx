        ...
        <View style={styles.container}>
            <Animated.View style={[styles.contentContainer, thirdIcon]}>
                <View style={styles.iconContainer} >
                    <Image style={styles.icon} source={require('../../assets/images/icons/PenIcon.png')} />
                </View>
            </Animated.View>
            <Animated.View style={[styles.contentContainer, secondIcon]}>
                <View style={styles.iconContainer} >
                    <Image style={styles.icon} source={require('../../assets/images/icons/FileIcon.png')} />
                </View>
            </Animated.View>
            <Animated.View style={[styles.contentContainer, firstIcon]}>
                <View style={styles.iconContainer} >
                    <Image style={styles.icon} source={require('../../assets/images/icons/FolderIcon.png')} />
                </View>
            </Animated.View>
            <Pressable onPress={handlePress} style={styles.contentContainer}>
                <Animated.View style={[styles.iconContainer, plusIcon]} >
                    <Image style={styles.icon} source={require('../../assets/images/icons/PlusIcon.png')} />
                </Animated.View>
            </Pressable>
        </View>
    );
